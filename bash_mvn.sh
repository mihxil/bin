...
export MAVEN_OPTS_NODEBUG8='-Xms512m -Xmx6048m -Djava.awt.headless=true -Duser.language=da -ea  -Djava.net.preferIPv4Stack=true'
export MAVEN_OPTS_NODEBUG='--add-opens java.base/java.lang=ALL-UNNAMED -Xms512m -Xmx6048m -Djava.awt.headless=true -Duser.language=da -ea  -Djava.net.preferIPv4Stack=true'
...
export MAVEN_OPTS_DEBUG="-Xms512m -Xmx6048m -Djava.awt.headless=true -Xrunjdwp:transport=dt_socket,address=4000,server=y,suspend=n -ea  -Dcom.sun.management.jmxremote --add-opens java.base/java.lang=ALL-UNNAMED "
...
export MAVEN_OPTS_DEBUG2="-Xms512m -Xmx6024m -Djava.awt.headless=true -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,address=4001,server=y,suspend=n -Duser.language=da -ea -Djava.net.preferIPv4Stack=true --add-opens java.base/java.lang=ALL-UNNAMED"

export MAVEN_OPTS_DEBUG8="-Xms512m -Xmx6024m -Djava.awt.headless=true -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,address=4000,server=y,suspend=n -Duser.language=da -ea -Djava.net.preferIPv4Stack=true"
...
alias mvnt='LC_CTYPE=UTF-8 mvn -DskipTests=false -DfailIfNoTests=false -D"maven.test.failure.ignore=true" ; after_maven'
alias mvnT='LC_CTYPE=UTF-8 mvn -DskipTests=false -DskipITs=false -DfailIfNoTests=false -D"maven.test.failure.ignore=true" ; after_maven'
